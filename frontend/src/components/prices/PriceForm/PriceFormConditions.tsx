...
import {
	PRICE_CONDITION_TYPES_MAP,
	type PriceConditionType,
} from 'src/lib/constants/price-conditions';
import type { PriceSubmitData } from './types';

const conditionInitialData: PriceSubmitData['conditions'][number] = {
...
const PriceFormConditions = () => {
	const form = useFormContext<PriceSubmitData>();
