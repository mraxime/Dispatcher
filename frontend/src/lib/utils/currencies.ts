import { PRICE_TYPES_MAP, type PriceType } from 'src/lib/constants/prices';
...
type ToCurrencyOptions = { priceType?: PriceType };

export const toCurrency = (number = 0, options?: ToCurrencyOptions): string => {
